...
const SIMS = ['plasmid-insertion', 'fermentation']
mkdirSync(destDir, { recursive: true })
console.log('Typechecking…')
execSync('npx tsc --noEmit', { cwd: root, stdio: 'inherit' })
for (const sim of SIMS) {
  console.log(`\nBuilding ${sim}…`)
  execSync('npx vite build', { cwd: root, stdio: 'inherit', env: { ...process.env, BIOTECH_SIM: sim } })
  const candidates = [
...
console.log('\nAll biotech SceneryStack sims built.')
