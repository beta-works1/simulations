...
export class RainbowDispersionScreenView extends ScreenView {
  ...
  public constructor(model: RainbowDispersionModel, providedOptions?: Options) {
    ...
    const conditionsHint = controlHint(RainbowDispersionStrings.conditionsHintStringProperty.value, contentW)
    ...
    const learnTip = createPanelTip(RainbowDispersionStrings.learnMoreStringProperty.value, { width: contentW, fontSize: 11 })
    ...
    const relayoutPanel = () => {
      ...
      speedSlider.left = 0; speedSlider.top = py; py = speedSlider.bottom + 6
