...
export class CurvedMirrorsScreenView extends ScreenView {
  ...
  public constructor(model: CurvedMirrorsModel, providedOptions?: Options) {
    ...
    panelContent.addChild(controlHint(CurvedMirrorsStrings.conditionsHintStringProperty.value, contentW))
    ...
    panelContent.addChild(createPanelTip(CurvedMirrorsStrings.learnMoreStringProperty.value, { width: contentW, fontSize: 11 }))
    ...
    const relayoutPanel = () => {
      ...
      objectDistSlider.left = 0; objectDistSlider.top = py; py = objectDistSlider.bottom + 12
  ...
  private drawStage(): void {
    ...
    this.labelsLayer.addChild(makeLabel('Object', objX - 28, ay - objectH - 10))
    this.labelsLayer.addChild(makeLabel(imageVirtual ? 'Virtual image' : 'Real image', imgX - 36, ay - imageH - 10))
  }
