...
import { AcidsColors } from '../AcidsColors.js'
...
export class DepthCard extends Node {
  ...
  public constructor(
    ...
    const fill =
      options.fill ??
      (variant === 'dark' ? AcidsColors.panelDark : AcidsColors.panelFill)
    const stroke = variant === 'dark' ? AcidsColors.panelDarkStroke : AcidsColors.panelStroke
    const titleFill = variant === 'dark' ? '#ecf0f1' : AcidsColors.ink
