...
const SIMS = ['acids-ph-scale', 'acid-base-neutralization', 'natural-indicator']
mkdirSync(destDir, { recursive: true })
console.log('Typechecking…')
execSync('npx tsc --noEmit', { cwd: root, stdio: 'inherit' })
for (const sim of SIMS) {
  console.log(`\nBuilding ${sim}…`)
  execSync('npx vite build', { cwd: root, stdio: 'inherit', env: { ...process.env, ACIDS_SIM: sim } })
  const candidates = [
...
console.log('\nAll acids SceneryStack sims built.')
