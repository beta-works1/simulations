...
const SIMS = ['balance-equations', 'exo-endo-thermic', 'ionic-covalent-bonds', 'conservation-of-mass']
mkdirSync(destDir, { recursive: true })
console.log('Typechecking…')
execSync('npx tsc --noEmit', { cwd: root, stdio: 'inherit' })
for (const sim of SIMS) {
  console.log(`\nBuilding ${sim}…`)
  execSync('npx vite build', { cwd: root, stdio: 'inherit', env: { ...process.env, REACTIONS_SIM: sim } })
  const candidates = [
...
console.log('\nAll reactions SceneryStack sims built.')
