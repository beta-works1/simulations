...
import { ReactionsColors } from '../ReactionsColors.js'
...
export class DepthCard extends Node {
  ...
  public constructor(
    ...
    const fill =
      options.fill ??
      (variant === 'dark' ? ReactionsColors.panelDark : ReactionsColors.panelFill)
    const stroke = variant === 'dark' ? ReactionsColors.panelDarkStroke : ReactionsColors.panelStroke
    const titleFill = variant === 'dark' ? '#ecf0f1' : ReactionsColors.ink
