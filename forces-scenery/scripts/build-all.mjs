...
const SIMS = ['balanced-unbalanced-forces', 'floating-sinking', 'pressure-force-area', 'hydraulic-lift', 'water-pressure-depth']
mkdirSync(destDir, { recursive: true })
console.log('Typechecking…')
execSync('npx tsc --noEmit', { cwd: root, stdio: 'inherit' })
for (const sim of SIMS) {
  console.log(`\nBuilding ${sim}…`)
  execSync('npx vite build', { cwd: root, stdio: 'inherit', env: { ...process.env, FORCES_SIM: sim } })
  const candidates = [
...
console.log('\nAll forces SceneryStack sims built.')
