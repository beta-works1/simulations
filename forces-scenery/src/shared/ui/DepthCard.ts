...
import { ForcesColors } from '../ForcesColors.js'
...
export class DepthCard extends Node {
  ...
  public constructor(
    ...
    const fill =
      options.fill ??
      (variant === 'dark' ? ForcesColors.panelDark : ForcesColors.panelFill)
    const stroke = variant === 'dark' ? ForcesColors.panelDarkStroke : ForcesColors.panelStroke
    const titleFill = variant === 'dark' ? '#ecf0f1' : ForcesColors.ink
