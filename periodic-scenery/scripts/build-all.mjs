...
const SIMS = ['periodic-table-builder', 'metal-nonmetal']
mkdirSync(destDir, { recursive: true })
console.log('Typechecking…')
execSync('npx tsc --noEmit', { cwd: root, stdio: 'inherit' })
for (const sim of SIMS) {
  console.log(`\nBuilding ${sim}…`)
  execSync('npx vite build', { cwd: root, stdio: 'inherit', env: { ...process.env, PERIODIC_SIM: sim } })
  const candidates = [
...
console.log('\nAll periodic SceneryStack sims built.')
