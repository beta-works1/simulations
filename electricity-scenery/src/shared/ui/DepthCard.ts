...
import { ElectricityColors } from '../ElectricityColors.js'
...
export class DepthCard extends Node {
  ...
  public constructor(
    ...
    const fill =
      options.fill ??
      (variant === 'dark' ? ElectricityColors.panelDark : ElectricityColors.panelFill)
    const stroke = variant === 'dark' ? ElectricityColors.panelDarkStroke : ElectricityColors.panelStroke
    const titleFill = variant === 'dark' ? '#ecf0f1' : ElectricityColors.ink
