...
const SIMS = ['ohm-law-circuit', 'series-parallel', 'short-circuit-fuse', 'electric-motor', 'speaker-mechanism']
mkdirSync(destDir, { recursive: true })
console.log('Typechecking…')
execSync('npx tsc --noEmit', { cwd: root, stdio: 'inherit' })
for (const sim of SIMS) {
  console.log(`\nBuilding ${sim}…`)
  execSync('npx vite build', { cwd: root, stdio: 'inherit', env: { ...process.env, ELECTRICITY_SIM: sim } })
  const candidates = [
...
console.log('\nAll electricity SceneryStack sims built.')
